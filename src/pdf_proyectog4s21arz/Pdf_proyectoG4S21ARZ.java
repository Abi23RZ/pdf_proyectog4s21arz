 ...
 * @author ABITA
 */
public class Pdf_proyectoG4S21ARZ {
    ...
    public static void main(String[] args) {
      ...
      try {
          ...
          Paragraph paragraph = new Paragraph("Hola este es mi primer conexion en pdf ");
          document.add(paragraph);
          PdfFont font = PdfFontFactory.createFont(FontConstants.HELVETICA_BOLD);
          
          cadena = "Soy mandi y que";
